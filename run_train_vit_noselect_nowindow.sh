...
RUN_NAME="${RUN_NAME:-same_video_triplet_xpool_adapter_vit12blocks_8f_noselect_nowindow}"
...
# ── Disabled selection & window expansion ────────────────────────────
...
# ── More unfrozen blocks for ViT ────────────────────────────────────
TRAIN_ENCODER_BASE_LAYERS="${TRAIN_ENCODER_BASE_LAYERS:-true}"
TRAIN_ENCODER_NUM_STAGES="${TRAIN_ENCODER_NUM_STAGES:-12}"
