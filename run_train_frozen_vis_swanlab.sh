...
RUN_NAME="${RUN_NAME:-same_video_triplet_xpool_adapter_warmup_16f_run1}"
...
VIDEO_READER_CACHE_SIZE="${VIDEO_READER_CACHE_SIZE:-3}"
...
LEVEL_BATCH_SIZES="${LEVEL_BATCH_SIZES:-fine:60,mid:20,coarse:20}"
...
SELECTION_LOSS_WARMUP_ZERO_EPOCHS="${SELECTION_LOSS_WARMUP_ZERO_EPOCHS:-5}"
SELECTION_LOSS_WARMUP_RAMP_EPOCHS="${SELECTION_LOSS_WARMUP_RAMP_EPOCHS:-5}"
