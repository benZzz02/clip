 #!/usr/bin/env bash
  ...
  NPROC=2
  EXP_NAME="train_window_denoise_8f_2"
  ...
  export SAVE_PREFIX="outputs/train_window_denoise_8f_run3/"
  ...
  torchrun --standalone --nproc_per_node="$NPROC" train_frozen_vis.py \
      ...
      --selection_loss_weight "$SELECTION_LOSS_WEIGHT" \
        --resume_from_checkpoint "/mnt/mydisk/CLIP/outputs/train_window_denoise_8f_run3/vlp_epoch_7.pt"