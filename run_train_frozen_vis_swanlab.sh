...
RUN_NAME="${RUN_NAME:-same_video_triplet_xpool_adapter_no_warmup_8f_run3}"
...
RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-outputs/same_video_triplet_xpool_adapter_no_warmup_8f_run3/vlp_epoch_35.pt}"
