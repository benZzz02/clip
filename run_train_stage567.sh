...
RUN_NAME="${RUN_NAME:-same_video_triplet_xpool_adapter_stage567_8f_run3}"
...
SELECTION_LOSS_WARMUP_ZERO_EPOCHS="${SELECTION_LOSS_WARMUP_ZERO_EPOCHS:-1}"
SELECTION_LOSS_WARMUP_RAMP_EPOCHS="${SELECTION_LOSS_WARMUP_RAMP_EPOCHS:-1}"
...
TRAIN_ENCODER_NUM_STAGES="${TRAIN_ENCODER_NUM_STAGES:-3}"
