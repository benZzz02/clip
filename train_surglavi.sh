...
EXP_NAME="${EXP_NAME:-surglavi_lora_single128}"
...
CUDA_VISIBLE_DEVICES="$CUDA_VISIBLE_DEVICES" TORCH_DISTRIBUTED_DEBUG="$TORCH_DISTRIBUTED_DEBUG" TORCH_SHOW_CPP_STACKTRACES="$TORCH_SHOW_CPP_STACKTRACES" SWANLAB_EXPERIMENT_NAME="$SWANLAB_EXPERIMENT_NAME" TB_LOGDIR="$TB_LOGDIR" PYTHONPATH="$PYTHONPATH" \
