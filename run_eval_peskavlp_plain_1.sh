...
export CKPT="${CKPT:-/data/surglavi_checkpoint/peskavlp_plain_surglavi_lora_3gpu_bs96/surglavi_epoch_40.pt}"
export OUTPUT_DIR="${OUTPUT_DIR:-./eval_outputs_peskavlp_plain}"
