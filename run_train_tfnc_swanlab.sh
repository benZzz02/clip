...
TFNC_UNIFORM_OUTSIDE_WEIGHT="${TFNC_UNIFORM_OUTSIDE_WEIGHT:-false}"
...
export TFNC_UNIFORM_OUTSIDE_WEIGHT
...
cmd=(
    ...
    --tfnc_uniform_outside_weight "$TFNC_UNIFORM_OUTSIDE_WEIGHT"
...
echo "  TFNC_UNIFORM_OUTSIDE_WEIGHT=$TFNC_UNIFORM_OUTSIDE_WEIGHT"
