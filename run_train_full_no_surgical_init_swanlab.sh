...
RUN_NAME="${RUN_NAME:-same_video_triplet_full_no_surgical_init_8f_run1}"
...
VIDEO_READER_CACHE_SIZE="${VIDEO_READER_CACHE_SIZE:-12}"
...
VISION_PRETRAINED_WEIGHTS="${VISION_PRETRAINED_WEIGHTS:-imagenet1k}"
...
TRAIN_WINDOW_EXPAND_RATIO="${TRAIN_WINDOW_EXPAND_RATIO:-2.0}"
