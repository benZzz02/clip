...
RUN_NAME="${RUN_NAME:-same_video_triplet_similarity_adapter_lemonfm_uniform_8f_stages2_run1}"
...
LEVEL_FRAME_TEMPERATURES="${LEVEL_FRAME_TEMPERATURES:-0.8,0.8,0.8}"
TRAIN_WINDOW_EXPAND_RATIO="${TRAIN_WINDOW_EXPAND_RATIO:-1.5}"
BASE_LOSS_WEIGHT="${BASE_LOSS_WEIGHT:-0.5}"
...
TRAIN_ENCODER_NUM_STAGES="${TRAIN_ENCODER_NUM_STAGES:-2}"
