...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print('Lens for hierarchical dataloaders: ', len(train_loaders[0]), len(train_loaders[1]), len(train_loaders[2]))
        ...
        for idx, train_loader in enumerate(train_loaders):
            ...
            if idx == 0:
                ...
                if epoch % 3 == 0 and epoch != 0:
                    train_hierarchy(writer, train_loader, model, criterions[idx], optimizer, scheduler, epoch, train_dataset, args, scaler, idx)
            elif idx == 2:
