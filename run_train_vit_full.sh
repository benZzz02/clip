...
RUN_NAME="${RUN_NAME:-same_video_triplet_xpool_adapter_vit_full_8f_run1}"
...
# 全量微调 ViT-L 全部 24 个 transformer blocks
TRAIN_ENCODER_BASE_LAYERS="${TRAIN_ENCODER_BASE_LAYERS:-true}"
TRAIN_ENCODER_NUM_STAGES="${TRAIN_ENCODER_NUM_STAGES:-0}"
