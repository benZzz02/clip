...
RUN_NAME="${RUN_NAME:-lemonfm_uniform_8f_original_timestamp_run1}"
...
TRAINING_METHOD="${TRAINING_METHOD:-original_timestamp}"
ANCHOR_SAME_VIDEO_TRIPLETS="${ANCHOR_SAME_VIDEO_TRIPLETS:-false}"
...
BASE_LOSS_WEIGHT="${BASE_LOSS_WEIGHT:-1.0}"
...
if [[ "$TRAINING_METHOD" != "original_timestamp" ]]; then
    echo "ERROR: This script expects TRAINING_METHOD=original_timestamp, got $TRAINING_METHOD" >&2
    exit 2
fi
...
echo "Original timestamp baseline config:"
echo "  RUN_NAME=$RUN_NAME"
echo "  EPOCHS=$EPOCHS"
echo "  LEARNING_RATE=$LEARNING_RATE"
echo "  NUM_FRAMES=$NUM_FRAMES"
echo "  PER_GPU_BATCH_SIZE=$PER_GPU_BATCH_SIZE"
echo "  ANNOTATION_LEVELS=$ANNOTATION_LEVELS"
echo "  LEVEL_BATCH_SIZES=$LEVEL_BATCH_SIZES"
echo "  TRAINING_METHOD=$TRAINING_METHOD"
echo "  ANCHOR_SAME_VIDEO_TRIPLETS=$ANCHOR_SAME_VIDEO_TRIPLETS"
echo "  TRAIN_WINDOW_EXPAND_RATIO=$TRAIN_WINDOW_EXPAND_RATIO"
echo "  SELECTION_LOSS_WEIGHT=$SELECTION_LOSS_WEIGHT"
echo "  CUDA_PREFETCH=$CUDA_PREFETCH"
